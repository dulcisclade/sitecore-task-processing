...
var LernSitecore = require("./scripts/LernSitecore.js");
...
gulp.task("Sync-Unicorn",
    function (callback) {
        var options = {};
        options.siteHostName = LernSitecore.getSiteUrl();
...
gulp.task("Publish-Assemblies",
    function () {
        var root = "./src";
        var binFiles = root + "/**/code/**/bin/LernSitecore.{Feature,Foundation,Common,Launchpad}.*.{dll,pdb}";
